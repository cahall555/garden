...
class Plant {
	...
	final DateTime updatedAt;
  	...
  	factory Plant.fromJson(Map<String, dynamic> json) {
			...
			date_planted: json['date_planted'] != null && json['date_planted'] != '' ? DateTime.parse(json['date_planted']) : null,
			date_germinated: json['date_germinated'] != null && json['date_germinated'] != '' ? DateTime.parse(json['date_germinated']) : null,
