...
class _GardenCreateState extends State<GardenCreate> {
    ...
    return Scaffold(
      ...
      body: ListView(
		...
		//	await gardenApi.initCsrfToken(); //see comment in app.go line 14
			if (_nameController.text.isNotEmpty && _zoneController.text.isNotEmpty) {
      				submitGarden();
    			} else {
 ...
 void submitGarden() async {
  try {
    ...
    await gardenProvider.createGarden({ // await gardenApi.createGarden(gardenData); see comment in app.go line 14
