...
[{"id":"bb28947d-0ddd-40f4-93b6-30e26db9405d","name":"Herb Garden","description":"So important for cooking.","account_id":"5d34bbee-7fc2-4e59-a513-8b26245d5abf","created_at":"2024-05-23T11:57:57.906107Z","updated_at":"2024-05-23T11:57:57.906107Z"}]
  ...
  final updateUri = Uri.parse(apiUrl + 'gardens?gardenId=bb28947d-0ddd-40f4-93b6-30e26db9405d');
  ...
  test('should update a garden with success when status code is 200', () async {
	...
	.thenAnswer((_) async => http.Response(jsonString, 200));
    await gardenApiService.updateGardenApi(updateGardenData, 'bb28947d-0ddd-40f4-93b6-30e26db9405d');
    verify(mockClient.put(updateUri,
	headers: anyNamed('headers'), body: json.encode(updateGardenData)));
  });

  final deleteUri = Uri.parse(apiUrl + 'gardens/bb28947d-0ddd-40f4-93b6-30e26db9405d?id=bb28947d-0ddd-40f4-93b6-30e26db9405d');
  ...
  test('should delete a garden with success when status code is 200', () async {
    ...
    await gardenApiService.deleteGardenApi('bb28947d-0ddd-40f4-93b6-30e26db9405d');
    verify(mockClient.delete(deleteUri, headers: anyNamed('headers')));
  });

final sqlInjectionUri = Uri.parse(apiUrl + 'gardens/?account_id=5d34bbee-7fc2-4e59-a513-8b26245d5abf\' OR 1=1 --');

  test('should fail to retrieve gardens when there is a SQL injection attempt', () async {
    when(mockClient.get(sqlInjectionUri))
        .thenAnswer((_) async => http.Response('SQL Injection Detected', 400));
    try {
      await gardenApiService.fetchGardenApi('5d34bbee-7fc2-4e59-a513-8b26245d5abf\' OR 1=1 --');
