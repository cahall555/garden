...
// in frontend/test/user_provider_test.dart.
...
import 'package:frontend/model/apis/user_api.dart' as _i8;
import 'package:frontend/model/user.dart' as _i3;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockUserApiService extends _i1.Mock implements _i8.UserApiService {
  MockUserApiService() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i4.Future<_i3.User> createUserApi(Map<String, dynamic>? userData) =>
      (super.noSuchMethod(
        Invocation.method(
          #createUserApi,
          [userData],
        ),
        returnValue: _i4.Future<_i3.User>.value(_FakeUser_3(
          this,
          Invocation.method(
            #createUserApi,
            [userData],
